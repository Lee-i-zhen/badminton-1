...
class Restaurant: NSObject, Codable {
    ...
    static func generateData(sourceArray: inout [Restaurant]) {
        sourceArray = [
            ...
            Restaurant(name: "KOREA OPEN 2021", type: "8/31~9/5", location: "TBC, KOREA", phone: "Super 500", summary: "The tournament is now known as Korea Open Super Series because it became one of the BWF Super Series tournaments beginning with 2007. ", image: "500-5", web: "https://bwfworldtour.bwfbadminton.com/tournament/3977/korea-open-2021/overview/", isVisited: false),
            
            Restaurant(name: "YONEX-SUNRISE HONG KONG OPEN 2021", type: "11/16~11/21", location: "HONG KONG COLISEUM, HONG KONG, HONG KONG CHINA", phone: "Super 500", summary: "TThe Hong Kong Open is an annual badminton tournament held in Hong Kong since 1982, but it did not take place annually.", image: "500-6", web:"https://bwfworldtour.bwfbadminton.com/tournament/3974/yonex-sunrise-hong-kong-open-2021/overview/", isVisited: false),
